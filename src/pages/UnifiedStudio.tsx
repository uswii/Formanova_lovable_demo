                    ...
                    >
                      ...
                      {isStudioOnboardingEnabled(user?.email) ? (
                        <svg
                          ...
                          viewBox="0 0 325.387 325.388"
                          fill="currentColor"
                          className="w-64 h-[22rem] md:w-80 md:h-[28rem] text-muted-foreground/20 mb-6"
                        >
                          <path d="M246.087,128.779c-0.983-190.244-134.985-113.46-134.985-113.46c-52.33-2.447-51.841,113.947-45.485,175.085c6.359,61.133-10.757,102.211-10.757,102.211c12.226-1.957,15.646-16.627,18.584-12.712c2.938,3.909,6.359,10.268,6.359,10.268c9.29-4.888,8.8-21.515,8.8-21.515c3.425,23.959,16.14,31.296,16.14,31.296c3.425,15.162,21.031,25.436,21.031,25.436c-15.162-44.02-5.383-201.491-5.383-201.491c10.758-14.672,9.784-65.534,9.784-65.534c14.183,25.919,83.632,56.731,83.632,56.731c0.979,6.358,16.622,13.696,16.622,13.696l0.491,12.228c7.333-14.672,10.269-9.292,8.312,9.29c-1.958,18.582-11.733,21.025-11.733,21.025c-2.449,24.943-22.505,48.908-22.505,48.908c-7.337,10.754,1.958,73.845,1.958,73.845c9.289,4.888,8.803,15.161,11.246,10.76c2.444-4.401,8.316-5.872,8.316-5.872c5.872,6.359,6.359,14.67,6.359,14.67c4.888-6.354,6.845-17.601,6.845-17.601c9.29,10.269,30.81,12.226,30.81,12.226C266.624,301.905,247.061,319.023,246.087,128.779z" />
                        </svg>
                      ) : (
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
