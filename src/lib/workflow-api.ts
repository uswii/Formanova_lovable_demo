...
export const FLUX_GEN_DAG_STEPS = {
  ...
  'composite': { progress: 60, label: 'Compositing...' },
  'resize_for_gemini': { progress: 65, label: 'Preparing for Gemini...' },
  'gemini_router': { progress: 68, label: 'Routing to Gemini...' },
  ...
  'output_mask_gemini': { progress: 95, label: 'Generating output mask...' },
...
export const ALL_JEWELRY_DAG_STEPS = {
  ...
  'gemini_quality_check': { progress: 58, label: 'Quality check...' },
  'output_mask_all_jewelry': { progress: 62, label: 'Output mask...' },
  'transform_detect': { progress: 68, label: 'Detecting transforms...' },
  'transform_apply': { progress: 75, label: 'Applying transforms...' },
  'transform_mask': { progress: 80, label: 'Transform mask...' },
  'gemini_hand_inpaint': { progress: 88, label: 'Inpainting...' },
  'final_composite': { progress: 94, label: 'Final composite...' },
